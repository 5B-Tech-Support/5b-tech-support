      ...
      <section className="bg-surface py-20 text-center">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
            Windows help that actually makes sense.
          </h1>
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat) => (
              <Link
                key={cat}
                href="/help-center"
                className="rounded-xl border border-border bg-background p-5 text-sm font-medium transition-colors hover:border-primary/40 hover:bg-primary/5"
              >
                {cat}
              </Link>
            ))}
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 max-w-3xl mx-auto">
            <div className="rounded-xl border border-border bg-background p-6">
              ...
              <p className="mt-3 text-sm text-muted">
                Limited tutorials, email support with 3 business day response.
              </p>
              <Link href="/register" className="btn-secondary mt-6 w-full !text-sm">
                Create Free Account
              </Link>
            </div>
            <div className="rounded-xl border border-primary/40 bg-background p-6">
              ...
              <p className="mt-3 text-sm text-muted">
                Full library, 48-hour email support. 1-month free trial, no
                credit card needed.
              </p>
